...
lost_file = fopen('flow-greedy_vs_lost.txt', 'w');
move_file = fopen('flow-greedy_vs_move.txt', 'w');
hop_file = fopen('flow-greedy_vs_hop.txt', 'w');
fprintf('Please wait');
for flow_avg = 90:100
...
system(['move ', 'flow-greedy_vs_lost.txt ', time]);
system(['move ', 'flow-greedy_vs_move.txt ', time]);
system(['move ', 'flow-greedy_vs_hop.txt ', time]);
